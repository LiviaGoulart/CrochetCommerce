//esse é o das faqs categories
async function fetchFAQs() {
  const response = await fetch("http://localhost/crochet/api/faqs/list");
...
/* ---- FAQ Accordion ---- */
function initFAQ() {
  const listFaqs = document.querySelector(".faq-container");
  if (!listFaqs) return;
